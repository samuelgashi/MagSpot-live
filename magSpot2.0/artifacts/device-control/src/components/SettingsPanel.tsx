...
export function SettingsPanel({ onClose }: { onClose: () => void }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-5" style={{ background: "rgba(0,0,0,0.56)", backdropFilter: "blur(5px)" }}>
      <div className="w-full max-w-5xl h-[82vh] rounded-2xl overflow-hidden flex flex-col" style={{ background: "rgba(10,13,22,0.98)", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "0 28px 90px rgba(0,0,0,0.7)" }}>
